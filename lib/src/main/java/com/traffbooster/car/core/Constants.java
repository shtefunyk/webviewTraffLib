...
public class Constants {
    ...
    public static final String KEY_APPSFLYER = "VkG4Hinj8rtcqAufBrTkz9";
    public static final String APPSFLYYER_STATUS = "af_status";
    public static final String APPSFLYYER_CAMPAIGN = "campaign";
}
